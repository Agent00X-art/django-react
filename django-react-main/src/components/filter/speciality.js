 ...
 */
 ...
 export default class speciality extends PureComponent {
  ...
  change_exp3(){
    ...
    this.state.exp3?(this.setState({result3:""})) : (this.setState({result6:"Дизайн,"}));
    this.handlExpChange()
   }
   change_exp4(){
    this.setState(previousState => {
   ...
   change_exp5(){
    ...
    this.state.exp5?(this.setState({result5:""})) : (this.setState({result5:"Биотехнологии,"}));
    this.handlExpChange()
  }
   change_exp6(){
    this.setState(previousState => {
    ...
    this.state.exp6?(this.setState({result6:""})) : (this.setState({result6:"Ресурсосберегающая энергетика,"}));
    this.handlExpChange()
  }
  change_exp7(){
    this.setState(previousState => {
    ...
    this.state.exp7?(this.setState({result7:""})) : (this.setState({result7:"Образовательные технологии,"}));
    this.handlExpChange()
  }
  change_exp8(){
    this.setState(previousState => {
    ...
    this.state.exp8?(this.setState({result8:""})) : (this.setState({result8:"Экономика,"}));
    this.handlExpChange()
  }
   change_exp9(){
    this.setState(previousState => {
    ...
    this.state.exp9?(this.setState({result9:""})) : (this.setState({result9:"Интелектуальные технологии,"}));
    this.handlExpChange()
  }
  handlExpChange = () => {
