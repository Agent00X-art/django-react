 ...
 */
 ...
 change_exp1(){
  ...
  this.state.exp1?(this.setState({result:""})) : (this.setState({result:"Без опыта,"}));
  this.handlExpChange()
 }
 change_exp2(){
  this.setState(previousState => {
  ...
  this.state.exp2?(this.setState({result2:""})) : (this.setState({result2:"3-6 мес,"}));
  this.handlExpChange()
}
 change_exp3(){
  this.setState(previousState => {
     ...
     <div className={`exp ${css(styles.group, styles.group_layout)}`}>
       <px-posize track-style='{"flexGrow":1}' x="0px minmax(500px,500px) 0px" y="0px minmax(287px,287px) 0px">
         <div className={css(styles.flex)}>
           {
                    this.state.exp1?(
                      <div className={css(styles.txt_selected, styles.txt1_layout)}onClick={this.change_exp1.bind(this)}>{'Без опыта'}
                      </div>
                ) : (
                  <div className={css(styles.txt1, styles.txt1_layout)}onClick={this.change_exp1.bind(this)}>{'Без опыта'}
                  </div>)
            }
           ...
           {
                    this.state.exp2?(
                      <div className={css(styles.txt_selected, styles.txt1_layout)}onClick={this.change_exp2.bind(this)}>{'3-6 мес'}</div>
                ) : (
                  <div className={css(styles.txt1, styles.txt1_layout)}onClick={this.change_exp2.bind(this)}>{'3-6 мес'}</div>)
            }
