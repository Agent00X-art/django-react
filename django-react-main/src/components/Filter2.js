...
import Exp from "./filter2/name";
import Speciality from "./filter2/speciality";
...
Filter = () => {
  var one = "Завод,АКЦИОНЕРНОЕ ОБЩЕСТВО НАУЧНО-ПРОИЗВОДСТВЕННОЕ ПРЕДПРИЯТИЕ «РУБИН»,Алмаз"
          ...
          <div className={css(styles.block1_layout)} >
            {
              this.state.on1 ? (
                ...
                <div className={css(styles.flex2, styles.flex2_layout)}onClick={this.changeON1.bind(this)}>
                  <h3 className={css(styles.subtitle_selected, styles.subtitle_layout)} >{'Предпрятия'} </h3>
                ...
                <div className={css(styles.block1)}>
                  <div className={css(styles.flex2, styles.flex2_layout)}onClick={this.changeON1.bind(this)}>
                    <h3 className={css(styles.subtitle, styles.subtitle_layout)} >{'Предпрятия'} </h3>
                    <div className={css(styles.flex2_spacer)} />
                    <div className={css(styles.flex2_item)}>
                      <div className={css(styles.cover_group, styles.cover_group_layout)}>
                        <img
          ...
          <div className={css(styles.block2_layout)} >
            {
              this.state.on2 ? (
                ...
                <div className={css(styles.flex2, styles.flex2_layout)}onClick={this.changeON2.bind(this)}>
                  <h3 className={css(styles.subtitle_selected, styles.subtitle_layout)} >{'Направления'} </h3>
                  <div className={css(styles.flex2_spacer)} />
                  <div className={css(styles.flex2_item)}>
                    <div className={css(styles.cover_group, styles.cover_group_layout)}>
                      <img
                ...
                <div className={css(styles.block2)}>
                  <div className={css(styles.flex2, styles.flex2_layout)}onClick={this.changeON2.bind(this)}>
                    <h3 className={css(styles.subtitle, styles.subtitle_layout)} >{'Направления'} </h3>
                    <div className={css(styles.flex2_spacer)} />
                    <div className={css(styles.flex2_item)}>
                      <div className={css(styles.cover_group, styles.cover_group_layout)}>
                        <img
