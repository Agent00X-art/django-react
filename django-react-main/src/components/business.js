...
class business extends Component {
  constructor(props) {
    ...
    this.state = {
      todoList: [],
      backurl: "АКЦИОНЕРНОЕ ОБЩЕСТВО НАУЧНО-ПРОИЗВОДСТВЕННОЕ ПРЕДПРИЯТИЕ «РУБИН»,Группа компаний «Айтеко»,Завод,Алмаз;IT и цифровые технологии,Медицинские технологии,Химические технологии,Биотехнологии,Ресурсосберегающая энергетика,Образовательные технологии,Экономика,Интелектуальные технологии,"
    }
    };
    ...
    refreshList = () => {
      ...
      axios
      .patch("http://localhost:8000/object/sortingbusiness",
      {
        sort_by:"name directions",
      ...
      <px-posize
        ...
        <div className={css(styles.block)}>
          <div className={css(styles.flex, styles.flex_layout)}>
                ...
                <div className={css(styles.block7, styles.block7_layout)}>
                  <div className={css(styles.small_text_body_box, styles.small_text_body_box_layout)}>
                    <div className={css(styles.small_text_body)}>
                      <span className={css(styles.small_text_body_span0)}>{'Направление: '}</span>
                      <span className={css(styles.small_text_body_span1)}>{item.directions}</span>
                    </div>
                  </div>
                  <div className={css(styles.text_body_box, styles.text_body_box_layout)}>
                    <div className={css(styles.text_body)}>
                      <span className={css(styles.text_body_span0)}>{'На рынке: '}</span>
                      <span className={css(styles.text_body_span1)}> </span>
                      <span className={css(styles.text_body_span2)}>{item.experience}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <span className={css(styles.medium_title_span2)}>{item.description}</span>
            <hr className={css(styles.hr, styles.hr_layout)}></hr>
            <div className={css(styles.block5, styles.block5_layout)}>
              <h2 className={css(styles.medium_title1, styles.medium_title1_layout)}>{'Описание задачи:'}</h2>
            ...
            <div className={css(styles.block1, styles.block1_layout)}>
              <h4 className={css(styles.highlights, styles.highlights_layout)}>{'Откликнуться'}</h4>
            </div>
          </div>
        </div>
      </px-posize>
